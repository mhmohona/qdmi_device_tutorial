...
#include "tutorial_qdmi/constants.h" // IWYU pragma: export
#include "tutorial_qdmi/types.h"     // IWYU pragma: export
 ...
 */
int tutorial_QDMI_device_initialize(void);
 ...
 */
int tutorial_QDMI_device_finalize(void);
 ...
 *  - Allocate a session with @ref tutorial_QDMI_device_session_alloc.
 *  - Set parameters for the session with @ref
 * tutorial_QDMI_device_session_set_parameter.
 *  - Initialize the session with @ref tutorial_QDMI_device_session_init.
 ...
 *  - Free the session with @ref tutorial_QDMI_device_session_free when it is no longer
 *    needed.
 *
 *  @{
 */
 ...
 */
typedef struct tutorial_QDMI_Device_Session_impl_d *tutorial_QDMI_Device_Session;
 ...
 * @c NULL. The session must be freed by calling @ref tutorial_QDMI_device_session_free
 ...
 * @return @ref QDMI_ERROR_FATAL if an unexpected error occurred.
 * @see tutorial_QDMI_device_session_set_parameter
 * @see tutorial_QDMI_device_session_init
 */
 ...
 * @ref tutorial_QDMI_device_session_set_parameter before calling this function. A
 ...
 * @return @ref QDMI_ERROR_FATAL if an unexpected error occurred.
 * @see tutorial_QDMI_device_session_set_parameter
 * @see tutorial_QDMI_device_session_query_device_property
 * @see tutorial_QDMI_device_session_query_site_property
 * @see tutorial_QDMI_device_session_query_operation_property
 * @see tutorial_QDMI_device_session_create_device_job
 */
 ...
 *  tutorial_QDMI_Device_Session handles created via the @ref device_session_interface
 ...
 * @ref tutorial_QDMI_device_session_init.
 */
int tutorial_QDMI_device_session_query_device_property(tutorial_QDMI_Device_Session session,
...
int tutorial_QDMI_device_session_query_operation_property(
    tutorial_QDMI_Device_Session session, tutorial_QDMI_Operation operation, size_t num_sites,
    const tutorial_QDMI_Site *sites, size_t num_params, const double *params,
 ...
 *  - Create a job with @ref tutorial_QDMI_device_session_create_device_job.
 *  - Set parameters for the job with @ref tutorial_QDMI_device_job_set_parameter.
 *  - Submit the job with @ref tutorial_QDMI_device_job_submit.
 *  - Check the status of the job with @ref tutorial_QDMI_device_job_check.
 *  - Wait for the job to finish with @ref tutorial_QDMI_device_job_wait.
 *  - Retrieve the results of the job with @ref tutorial_QDMI_device_job_get_results.
 *  - Free the job with @ref tutorial_QDMI_device_job_free when it is no longer used.
 *
 *  @{
 */
 ...
 */
typedef struct tutorial_QDMI_Device_Job_impl_d *tutorial_QDMI_Device_Job;
 ...
 * tutorial_QDMI_device_job_free when it is no longer used.
 ...
 * functions @ref tutorial_QDMI_device_job_check and @ref tutorial_QDMI_device_job_wait can be
 ...
 * tutorial_QDMI_device_job_get_results.
 ...
 */
int tutorial_QDMI_device_job_wait(tutorial_QDMI_Device_Job job, size_t timeout);
 ...
 */
int tutorial_QDMI_device_job_get_results(tutorial_QDMI_Device_Job job, QDMI_Job_Result result,
