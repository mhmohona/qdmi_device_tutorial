...
enum QDMI_DEVICE_SESSION_PARAMETER_T {
   ...
   * calling @ref tutorial_QDMI_device_session_init.
   */
 ...
 * tutorial_QDMI_device_job_set_parameter.
 * @details If not noted otherwise, parameters are optional and devices must not
 * require them to be set.
 */
enum QDMI_DEVICE_JOB_PARAMETER_T {
   ...
   * format, the @ref tutorial_QDMI_device_job_set_parameter function must return @ref
   ...
   * If the program is invalid, the @ref tutorial_QDMI_device_job_set_parameter function
   * must return @ref QDMI_ERROR_INVALIDARGUMENT. If the program is valid, but
   * the device cannot execute it, the @ref tutorial_QDMI_device_job_set_parameter
 ...
 * tutorial_QDMI_device_job_query_property as part of the @ref
 * device_interface "device interface".
 * @details In particular, every parameter's value that can be set via @ref
 * tutorial_QDMI_device_job_set_parameter can be queried.
 */
enum QDMI_DEVICE_JOB_PROPERTY_T {
   ...
   * It may be used to recover a @ref tutorial_QDMI_Device_Job handle upon device
   * failure.
 ...
 * tutorial_QDMI_device_session_query_device_property as part of the @ref
...
enum QDMI_DEVICE_PROPERTY_T {
  ...
  /**
   * @brief `tutorial_QDMI_Site*` (@ref tutorial_QDMI_Site list) The sites of the device.
   * @details The returned @ref tutorial_QDMI_Site handles may be used to query site
  ...
  /**
   * @brief `tutorial_QDMI_Operation*` (@ref tutorial_QDMI_Operation list) The operations
   * supported by the device.
   * @details The returned @ref tutorial_QDMI_Operation handles may be used to query
   * operation properties.
   */
  QDMI_DEVICE_PROPERTY_OPERATIONS = 6,
  /**
   * @brief `tutorial_QDMI_Site*` (@ref tutorial_QDMI_Site list) The coupling map of the device.
   ...
   *
   * The sites returned in that list are represented as @ref tutorial_QDMI_Site handles.
...
/// tutorial_QDMI_device_session_query_site_property as part of the @ref device_interface
...
/// tutorial_QDMI_device_session_query_operation_property as part of the @ref
/// device_interface "device interface" and via @ref
...
enum QDMI_OPERATION_PROPERTY_T {
  ...
  /**
   * @brief `tutorial_QDMI_Site*` (list) The sites to which the operation is applicable.
   * @details
...
enum QDMI_DEVICE_PULSE_SUPPORT_LEVEL_T {
   ...
   * @see tutorial_QDMI_Site for more information on the site abstraction.
   */
  ...
  /**
   * @brief The device supports pulse-level control at an abstraction level of
   * @ref tutorial_QDMI_Site and `QDMI_Pulse_Channel`.
   * @details This means that the device can execute pulse-level instructions on
