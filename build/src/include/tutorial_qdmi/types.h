 ...
 * ```
 * struct tutorial_QDMI_Site_impl_d {
 *   size_t id;
 * };
 * ```
 */
typedef struct tutorial_QDMI_Site_impl_d *tutorial_QDMI_Site;
 ...
 * ```
 * struct tutorial_QDMI_Operation_impl_d {
 *   std::string name;
 * };
 * ```
 */
typedef struct tutorial_QDMI_Operation_impl_d *tutorial_QDMI_Operation;
